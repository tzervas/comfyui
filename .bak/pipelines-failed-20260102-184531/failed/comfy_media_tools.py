...
Notes:
- Pipelines loader only loads *.py directly under PIPELINES_DIR.
- Keep helper code in this file (no cross-module imports), otherwise the loader will move it to pipelines/failed.
"""
